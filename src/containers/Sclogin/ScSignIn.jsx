...
const ScSignIn = props => {
  ...
  const { signinError } = useSelector(state => state.scSignin);
  if (localStorage.getItem('scdata')) {
    props.history.push('/servicecentre');
  }
...
export default withRouter(ScSignIn);
