      ...
      <div className={'form-bod'}>
        ...
        <div className={'tnc-bod'}>
          ...
          <p>
            ...
            collectively refer to “ETark Technology Private Limited”, also known
            as “ETark” and the terms "You" /"Your" / "Yourself" refer to the
            users.
          </p>
          <br />
          <p>
          ...
          <p>
            ...
            ETark (both terms defined above). The terms of this Privacy Policy
            ...
            relationship between you and ETark for your use of the website
            www.etark.in
          </p>
          <br />
          <p>
          ...
          <p>
            ...
            a) your name, b) email address, c) address d) location coordinates
            e) PIN code, f) contact number. The Information as supplied by the
            users enables us to improve our sites and provide you the most
            ...
            services) and for developing new services Such information will not
            be considered as sensitive if it is freely available and accessible
            in the public domain or is furnished under the Right to Information
          ...
          <p>
            ...
            (an example of this is when you ask for our pickup and delivery
            service which requires us to collect your geo-tag location for
            accurate delivery cost estimations). A cookie cannot read data off
          ...
          <p>
            ...
            <br />
            <br />
            <b>(a)</b> When it is requested or required by law or by any court
            or governmental agency or authority to disclose, for the purpose of
            ...
            <br />
            <br />
            <b>(b)</b> We propose to share such information within its group
